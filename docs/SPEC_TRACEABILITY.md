...
This matrix maps the attached 77-section implementation specification to the committed scaffold and stable backlog task IDs. It is a coverage aid, not a substitute for task acceptance criteria.

| Specification sections | Subject | Scaffold or tasks |
| --- | --- | --- |
...
| 8 | Repository layout | Current repository scaffold |
| 9-13 | Artist configuration, creation, listing, and status | Artist models/template, LM-007, LM-008 |
| 14-17 | Immutable originals, song layout, catalog, ingest, normalization | LM-010 through LM-014 |
| 18-20 | Stem separation, vocal review, reference library | LM-015, LM-017 |
| 21-24 | Lyrics, musical metadata, ACE dataset, evaluation split | LM-016, LM-019 |
| 25-30 | Shared models, artist adapters, training configuration, quick run, checkpoint evaluation | LM-003, LM-004, LM-023 through LM-026 |
| 31-32 | Zero-shot voice test and multiple references | LM-020 through LM-022 |
| 33-41 | Generation UX/request/pipeline, typed domains, replaceable interfaces, reference selection | Domain and engine protocols, LM-020, LM-028 through LM-034 |
| 42 | Primary synchronized MVP strategy | LM-030 |
| 43-44 | Score-controlled and advanced composition modes | LM-038 |
| 45 | Timing-safe mixing | LM-030 |
| 46-51 | Immutable runs, provenance, inspection, reproduction, variants | LM-028, LM-031, LM-033, LM-034 |
| 52-55 | Presets, music/voice evaluation, optional voice fine-tuning | LM-021, LM-022, LM-026, LM-027, LM-033 |
| 56-60 | App/engine configuration, environment isolation, diagnostics | Config and environment scaffold, LM-001 through LM-006 |
...
| 73 | Mandatory artist isolation | Path scaffold, LM-010, LM-035, LM-036 |
